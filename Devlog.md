...
## 2026-03-28
**Work:** Infix validation + infix→postfix conversion
- Implemented `isValidInfix()` with token-order rules and balanced parentheses checks.
- Implemented `precedence()` for operator priority (*,/ > +,-).
- Implemented `infixToPostfix()` using a stack-based shunting-yard conversion.

**Testing:**
- `3 + 4 * 2` → postfix `3 4 2 * +`, result 11
